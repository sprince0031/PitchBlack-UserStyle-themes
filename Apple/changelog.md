# Changelog
### v0.6.6
- Fixed broken side nav pane UI after Apple Music UI overhaul.
- Minor fixes to UI consistency issues like colours not inverting on selecting track from list, etc.
